...
```bash
openclaw cron add --name kalshi-bet --every 30m --agent kalshi-trading-protection --message "Run betting script: powershell -ExecutionPolicy Bypass -File C:\Users\pablobots\.openclaw\workspace\.openclaw\workspace-bumba\skills\kalshi-auto-bet\scripts\kalshi-bet-cron.ps1. Report what happened." --timeout-seconds 180 --tools exec --announce --to telegram:5804173449
```
