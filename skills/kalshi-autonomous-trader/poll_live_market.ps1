...
const PRIVATE_KEY_PATH = process.env.KALSHI_PRIVATE_KEY_PATH || 'C:\\Users\\pablobots\\.openclaw\\media\\inbound\\Pinguilo-2---1e30c2a4-95ed-4b2b-baf1-bfbeb8a6f90a.txt';
const CLI_PATH = 'C:\\Users\\pablobots\\.openclaw\\skills\\skills\\kalshi-trading\\scripts\\kalshi-cli.mjs';
